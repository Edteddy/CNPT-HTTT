  ...
  ==============================================-->
		...
		<div class="row">
			...
			<div class="span4">
				...
				<h1 align="center">Ám ảnh Toeic</h1>
				<p align="justify">Mỗi năm, có hàng nghìn học viên trượt kỳ thi tiếng Anh đầu vào cũng như khó khăn trong việc kiếm
					đủ điểm nộp bằng đầu ra. Vì thế với một sự ám ảnh tột độ với kì thi Toeic, chúng tôi đã thành lập ra trang web này
					nhằm giúp các bạn sinh viên HUB có một nơi để học tập và trao dồi kiến thức trước khi đi thi Toeic. Chúc các bạn có những con điểm Toeic đáng mơ ước!
				</p>
